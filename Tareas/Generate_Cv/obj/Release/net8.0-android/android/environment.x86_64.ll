...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4040548539382057815, ; hash 0x3812e97d23974b57, from name: aot-Generate_Cv
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 103
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6986609704954327796, ; hash 0x60f56c82901972f4, from name: aot-Generate_Cv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 156
	...
	%struct.DSOCacheEntry {
		i64 9754255920096859106, ; hash 0x875e14143d9fd3e2, from name: Generate_Cv
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 243
	...
	%struct.DSOCacheEntry {
		i64 10843829990486855072, ; hash 0x967d05ec5bb24da0, from name: Generate_Cv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 271
	...
	%struct.DSOCacheEntry {
		i64 15063992213357674620, ; hash 0xd10e0d1b086f407c, from name: libaot-Generate_Cv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 393
	...
	%struct.DSOCacheEntry {
		i64 15894645610979450893, ; hash 0xdc951ff84126e00d, from name: libaot-Generate_Cv
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 414
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0fea16cd-5a7f-42c2-b221-8c29caafaaf2\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.generate_cv\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-Generate_Cv.dll.so\00", align 16
