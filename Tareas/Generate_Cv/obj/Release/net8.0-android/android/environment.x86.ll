...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 840074615, ; hash 0x32128577, from name: libaot-Generate_Cv
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2822329612, ; hash 0xa839550c, from name: aot-Generate_Cv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 318
	...
	%struct.DSOCacheEntry {
		i64 3336966040, ; hash 0xc6e60f98, from name: aot-Generate_Cv
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 379
	...
	%struct.DSOCacheEntry {
		i64 3824200232, ; hash 0xe3f0aa28, from name: libaot-Generate_Cv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 427
	...
	%struct.DSOCacheEntry {
		i64 4064332872, ; hash 0xf240cc48, from name: Generate_Cv
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 455
	...
	%struct.DSOCacheEntry {
		i64 4213915000, ; hash 0xfb2b3d78, from name: Generate_Cv.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Generate_Cv.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
