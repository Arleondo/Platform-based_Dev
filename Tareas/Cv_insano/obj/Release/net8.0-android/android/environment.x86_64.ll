...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4997909039287091410, ; hash 0x455c23ca8a6bc0d2, from name: libaot-Cv_insano.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9637138111686329470, ; hash 0x85bdfe0d8671447e, from name: libaot-Cv_insano
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 239
	...
	%struct.DSOCacheEntry {
		i64 9995967373136660939, ; hash 0x8ab8cf5d6e3489cb, from name: Cv_insano
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 249
	...
	%struct.DSOCacheEntry {
		i64 15120715042220023679, ; hash 0xd1d79237c96e1f7f, from name: aot-Cv_insano.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
	...
	%struct.DSOCacheEntry {
		i64 16598813648245873797, ; hash 0xe65ad5119c99dc85, from name: aot-Cv_insano
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
	...
	%struct.DSOCacheEntry {
		i64 17579799635365358749, ; hash 0xf3f7fea0687e6c9d, from name: Cv_insano.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 453
...
@.env.3 = private unnamed_addr constant [37 x i8] c"871fde05-d19e-443e-b69e-034b22d2ca52\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.cv_insano\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-Cv_insano.dll.so\00", align 16
