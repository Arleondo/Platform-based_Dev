...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 656433520, ; hash 0x27206170, from name: Cv_insano
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1261541811, ; hash 0x4b3199b3, from name: aot-Cv_insano
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 2697532165, ; hash 0xa0c91305, from name: libaot-Cv_insano.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 302
	...
	%struct.DSOCacheEntry {
		i64 3473672854, ; hash 0xcf0c0a96, from name: aot-Cv_insano.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
	...
	%struct.DSOCacheEntry {
		i64 3650586105, ; hash 0xd99785f9, from name: libaot-Cv_insano
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 412
	...
	%struct.DSOCacheEntry {
		i64 4231413865, ; hash 0xfc364069, from name: Cv_insano.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Cv_insano.dll.so
		ptr null; void* handle (0x0)
	}, ; 474
